    ...
    <div class="container select-params col-md-8 align-content-center">
      <form>
        <div class="form-group row">
          <label for="due" class="col-md-6 col-form-label">Określ vin (minimalna liczba opóźnionych rat) </label>
        ...
        <div class="form-group row">
          ...
          <div id="variableName" class="">
            ...
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['APP_CHAR_BRANCH', 'APP_LOAN_AMOUNT', 'APP_N_INSTALLMENTS', 'APP_INSTALLMENT', 'APP_CHAR_JOB_CODE'] ">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['APP_CHAR_GENDER','APP_CHAR_CARS', 'APP_CHAR_CITY','APP_CHAR_HOME_STATUS','APP_SPENDINGS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['APP_LOAN_AMOUNT', 'APP_N_INSTALLMENTS', 'APP_INSTALLMENT', 'APP_CHAR_CARS', 'APP_SPENDINGS']">
                {{variable}}
              </option>
            </select>
            ...
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['ACT9_N_GOOD_DAYS', 'ACT_CCSS_N_LOAN', 'ACT6_N_GOOD_DAYS', 'ACT_CALL_N_LOAN', 'ACT12_N_GOOD_DAYS'] ">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['ACT_CCSS_MIN_SENIORITY', 'ACT_CCSS_N_STATB', 'ACT_CCSS_DUEUTL', 'ACT_CCSS_MIN_LNINST', 'ACT9_N_GOOD_DAYS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option v-for="variable in ['ACT_CALL_CC', 'ACT_LOANINC', 'ACT_CC', 'ACT_CINS_N_STATB', 'ACT_CINS_ALL']">
                {{variable}}
              </option>
            </select>
            ...
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['AGR3_MEAN_CMAXI_DAYS', 'AGR3_MAX_CMAXI_DAYS', 'AGR12_MAX_CMAXA_DUE', 'AGR9_MAX_CMAXA_DUE', 'AGR6_MAX_CMAXA_DUE']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['AGR12_MEAN_CMAXC_DUE', 'AGR12_MAX_CMAXC_DUE', 'AGR9_MAX_CMAXC_DUE', 'AGR12_MAX_CMAXC_DAYS', 'AGR6_MAX_CMAXC_DUE']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['AGR3_MAX_CMAXI_DAYS', 'AGR6_MIN_CMAXI_DAYS', 'AGR6_MAX_CMAXI_DAYS', 'AGR9_MIN_CMAXI_DAYS', 'AGR12_MIN_CMAXI_DAYS']">
                {{variable}}
              </option>
            </select>
            ...
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['AGS9_MAX_CMAXA_DAYS', 'AGS12_MAX_CMAXA_DAYS', 'AGS12_MEAN_CMAXI_DAYS', 'AGS12_MAX_CMAXI_DAYS', 'AGS9_MAX_CMAXI_DAYS'] ">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['AGS12_MEAN_CMAXC_DUE', 'AGS12_MAX_CMAXC_DUE', 'AGS6_MAX_CMAXC_DUE', 'AGS9_MAX_CMAXC_DUE','AGS9_MEAN_CMAXC_DUE']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['AGS9_MEAN_CMAXI_DAYS', 'AGS3_MAX_CMAXI_DAYS', 'AGS6_MAX_CMAXI_DAYS', 'AGS9_MAX_CMAXI_DAYS', 'AGS3_MEAN_CMAXI_DAYS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['APP_CHAR_BRANCH', 'APP_LOAN_AMOUNT', 'APP_INSTALLMENT', 'APP_N_INSTALLMENTS', 'APP_CHAR_CARS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['APP_CHAR_GENDER', 'APP_CHAR_CITY', 'APP_CHAR_CARS', 'APP_CHAR_HOME_STATUS', 'APP_SPENDINGS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option
                v-for="variable in ['APP_LOAN_AMOUNT', 'APP_INSTALLMENT', 'APP_N_INSTALLMENTS', 'APP_CHAR_CARS', 'APP_CHAR_GENDER']">
                {{variable}}
              </option>
            </select>
            ...
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['ACT3_N_GOOD_DAYS', 'ACT6_N_GOOD_DAYS', 'ACT_CCSS_N_LOAN', 'ACT_CALL_N_LOAN', 'ACT9_N_GOOD_DAYS'] ">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['ACT_CCSS_MIN_SENIORITY', 'ACT_CCSS_N_STATB', 'ACT_CCSS_DUEUTL', 'ACT_CCSS_MAXDUE', 'ACT_CMAXC_DUE']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['ACT_CALL_CC', 'ACT_CC', 'ACT_LOANINC', 'ACT_CINS_N_STATB', 'ACT_CINS_ACP']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['AGR3_MIN_CMAXI_DAYS', 'AGR3_MAX_CMAXI_DAYS', 'AGR6_MAX_CMAXA_DUE', 'AGR6_MIN_CMAXI_DAYS', 'AGR3_MEAN_CMAXI_DAYS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['AGR6_MEAN_CMAXC_DUE', 'AGR12_MEAN_CMAXC_DUE', 'AGR12_MAX_CMAXC_DUE', 'AGR12_MAX_CMAXC_DAYS', 'AGR9_MAX_CMAXC_DUE']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['AGR3_MIN_CMAXI_DAYS', 'AGR6_MIN_CMAXI_DAYS', 'AGR3_MEAN_CMAXI_DAYS', 'AGR6_MAX_CMAXI_DAYS', 'AGR9_MIN_CMAXI_DAYS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['AGS9_MAX_CMAXA_DAYS', 'AGS12_MAX_CMAXA_DAYS', 'AGS12_MIN_CMAXI_DAYS', 'AGS12_MAX_CMAXI_DAYS', 'AGS9_MIN_CMAXI_DAYS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['AGS6_MEAN_CMAXC_DUE', 'AGS12_MEAN_CMAXC_DUE', 'AGS6_MAX_CMAXC_DUE', 'AGS9_MAX_CMAXC_DUE', 'AGS12_MAX_CMAXC_DUE']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['AGS9_MEAN_CMAXI_DAYS', 'AGS6_MIN_CMAXI_DAYS', 'AGS6_MAX_CMAXI_DAYS', 'AGS12_MEAN_CMAXI_DAYS', 'AGS6_MEAN_CMAXI_DAYS']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
            ...
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['APP_CHAR_GENDER', 'APP_CHAR_CITY', 'APP_CHAR_HOME_STATUS', 'APP_CHAR_CARS', 'APP_NUMBER_OF_CHILDREN']">
                {{variable}}
              </option>
            </select>
            <select class="form-control btn btn-secondary"
              ...
              <option selected
                      v-for="variable in ['APP_LOAN_AMOUNT', 'APP_INSTALLMENT', 'APP_N_INSTALLMENTS', 'APP_CHAR_MARITAL_STATUS', 'APP_CHAR_CARS']">
                {{variable}}
              </option>
            </select>
          </div>
        ...
        <div class="results" v-if="allValuesProvided">
          <h4>Wartości dla klasy: {{ this.getCategories(this.due, this.walletType, this.grupa, this.variableName,
            1).war}}</h4><br>
